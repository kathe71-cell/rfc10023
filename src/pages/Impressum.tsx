    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <div className="border-b border-slate-200 pb-6">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-100 text-slate-800 text-xs font-mono font-bold uppercase mb-3">
          ...
          <span>Rechtliche Anbieterkennzeichnung</span>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 space-y-6 shadow-xs">
        ...
        <div className="pt-4 border-t border-slate-100">
          ...
          <p className="text-xs text-slate-600 leading-relaxed">
            rfc10023.de ist ein unabhängiges, privates Fachportal und Dokumentationsangebot zur IETF-Spezifikation RFC 10023. 
            Es besteht kein gesellschaftsrechtliches Verhältnis oder eine sonstige geschäftliche Bindung zur Internet Engineering Task Force (IETF), DENIC eG, SIDN oder genannten DNS-Dienstleistern.
          </p>
        </div>
